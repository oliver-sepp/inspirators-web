...
<div class="flex flex-col justify-between md:mt-[15vh] mb-[5vh] md:mb-[10vh]">
    ...
    <div class="flex flex-col justify-center m-4 items-center min-[1000px]:items-start gap-[5vw] text-[var(--dark-blue)] min-[1000px]:flex-row md:gap-[10vw]">
        ...
        <div class="flex flex-col lg:order-1 space-y-4 lg:mx-10 w-5/6 text-[20px] lg:w-2/7">
            ...
            <p>
                We are also committed to social responsibility and sustainability, as we believe that equal opportunities and environmental preservation are essential for future generations. At Inspirators!, we are proud to be part of the movement towards a more efficient and sustainable future.
            </p>
