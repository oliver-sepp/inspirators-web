<div class="absolute inset-0 z-20 flex flex-col md:flex-row justify-center items-center px-[10vw] sm:px-0 md:pl-[10vw] gap-8 md:gap-[25vh] py-[5vh] md:py-0 md:pt-[10vh] lg:py-[20vh]">
