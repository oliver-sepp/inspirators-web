...
<div class="flex flex-col justify-between md:mt-[15vh] mb-[5vh] md:mb-[10vh]">
    ...
    <div class="flex flex-col justify-center items-center min-[1000px]:items-start md:gap-[10vw] text-[#05266A] min-[1000px]:flex-row gap-[5vw]">
        ...
        <div class="flex flex-col space-y-4 lg:mx-10 w-5/6 text-[20px] lg:w-2/7">
            <p>
                Near real-time analytics solution for Elenger AS (daughter company of listed company Tallink Group).
            </p>
            <p>
                Inspirators! created a data collection and analytic solution that is up and running 24/7, allowing better a base for wiser decisions. The existing manual solution was replaced with automation.
            </p>
            ...
            <div class="flex flex-row mb-4 items-start">
                ...
                <p>
                    <b>
                        Relevant data update speed increased 1,000 %
                    </b>
                </p>
            </div>
            <p>
                Together with the Elenger business team, IT team, and Inspirators!, it took 1 day to design the solution from scratch. In 5 days, Inspirators! launched the first working concept, and then go on to fine-tune the details. New analytics solution was delivered in just a few weeks.
            </p>
        </div>
