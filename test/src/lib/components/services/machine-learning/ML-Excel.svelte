...
import ExcelImage from '$lib/assets/services/machine-learning/ML-excel.png';
</script>
...
<div class="flex flex-col justify-between md:mt-[15vh] mb-[5vh] md:mb-[10vh]">
    <div class="flex flex-col justify-evenly w-full m-4 mb-20 md:flex-row">
        ...
        <div class="flex flex-row mt-10 ml-4" >
            ...
            <img src={number04} alt="04" class="max-h-10 md:max-h-15 lg:max-h-20 w-auto mr-7">
        </div>
    </div>
    <div class="flex flex-col justify-center items-center min-[1000px]:items-start md:gap-[10vw] text-[#05266A] min-[1000px]:flex-row gap-[5vw]">
        ...
        <div class="flex flex-col space-y-4 lg:mx-10 w-5/6 text-[20px] lg:w-2/7">
            <p>
                Say goodbye to the unreliability, especially in complex macros and multi-user Excel scenarios. We replace convoluted spreadsheets with powerful, easy-to-use data analysis products. No more limitations; handle vast datasets effortlessly.
            </p>
            <p>
                We understand the demands of the energy sector, where Excel's constraints are simply not acceptable. Our solutions liberate your data potential.
            </p>
        </div>
