...
<div class="flex flex-col justify-between md:mt-[15vh]">
    <div class="flex flex-col justify-evenly w-full m-4 mb-20 md:flex-row">
        <div class="w-full text-[var(--dark-blue)] mx-3 pb-14 relative md:w-2/5 mx-0">
            <h1 class="w-9/10 text-[3rem] md:text-[4rem] lg:text-[3rem]">
                Unlock speed and clarity <br> in your legacy systems
            </h1>
    ...
    <div class="flex flex-col justify-center gap-[3vw] text-[var(--dark-blue)] md:flex-row gap-[5vw]">
        <div class="flex flex-col space-y-4 mx-10 w-5/6 text-[20px] md:w-2/6">
            ...
            <p>
                At Inspirators!, we use AI assisted methods to dramatically speed up and simplify this process.
            </p>
            <p>
